...
class TrainerConfig:
    router_state_path: Path = Path("/opt/gta-ai/training/runtime/router-state.json")
    pending_manifest_path: Path = Path("/opt/gta-ai/training/queue/pending.json")
    deployed_manifest_path: Path = Path("/opt/gta-ai/training/runtime/deployed.json")
    candidate_manifest_path: Path = Path("/opt/gta-ai/training/runtime/candidate.json")
    active_adapter_path: Path = Path("/opt/gta-ai/training/adapters/active")
    status_path: Path = Path("/opt/gta-ai/training/runtime/trainer-state.json")
